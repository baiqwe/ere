                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-slate-800/30 rounded-2xl p-8 border border-slate-700">
                            ...
                            <div className="space-y-4 text-slate-400">
                                <p>
                                    {isZh
                                        ? `${siteConfig.name} 是一个 AI 图像生成平台，围绕 ERNIE Image 能力提供高效、易用的创作体验。我们提供：`
                                        : `${siteConfig.name} is an AI image generation platform built around ERNIE Image capabilities for a fast and accessible creative workflow. We provide:`}
                                </p>
