...
export default function GLMImageGenerator({ user, locale = "en", t }: GLMImageGeneratorProps) {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            a.href = url;
            a.download = `ernie-image-${Date.now()}.webp`;
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-3xl font-bold tracking-tight">
                            🚀 {locale === "zh" ? "ERNIE Image 图像生成器" : "ERNIE Image Generator"}
                        </h1>
                            ...
                            <Card className="p-4 bg-blue-500/10 border-blue-500/30">
                                <div className="text-center space-y-3">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        {locale === "zh"
                                            ? "创建免费账户开始使用 ERNIE Image 生成图像。免费获得 3 次生成机会！"
                                            : "Create a free account to start generating images with ERNIE Image. Get 3 free generations!"}
                                    </p>
                                    <Button
                            ...
                            {resultImage ? (
                                ...
                                <div className="flex flex-col items-center gap-4 text-muted-foreground">
                                    ...
                                    <span className="text-lg">
                                        {locale === "zh" ? "ERNIE Image 正在创作..." : "ERNIE Image is creating..."}
                                    </span>
